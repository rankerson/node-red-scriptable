...
write2log("Anzahl Fehlermeldungen: " + errormsg.length,2);
if (errormsg.length  != 0) {
	sizeErrorMsg = sizeErrorMsg - errormsg.length;
...
async function createWidgetFooter(widget) {
	...
	const updateEntry = widget.addText(update_time + ", v1.01");
...
function write2error(err_msg_txt) {
